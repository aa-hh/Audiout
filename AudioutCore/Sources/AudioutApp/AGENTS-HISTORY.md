# AGENTS.md history: AudioutCore/Sources/AudioutApp
...
- **One surface, and this target only COMPOSES it.** `AppSurfaceController`
  (AudioutPopoverUI) owns the window, the three screens and the menu-bar
...
first-run window (`AudioutOnboardingUI`, a standalone movable
