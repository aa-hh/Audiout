    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                checklistRow("Open Audiouter on your Mac and keep it running.")
                checklistRow("In Audiouter's Settings › General on your Mac, turn on \u{201C}Allow control from iPhone on this network.\u{201D}")
            }
        }
        .padding(.vertical, 8)
