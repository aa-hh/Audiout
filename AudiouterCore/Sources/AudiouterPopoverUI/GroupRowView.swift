...
public final class GroupRowView: NSView {
    ...
    private func installMouseMovedMonitor() {
        ...
        // STABILITY(D4): every row installs its own app-wide monitor, churned on each rebuild — any fix should reduce multiplicity/churn only; the monitor pattern itself is deliberate (see AudiouterSharedUI/AGENTS.md); see dev/notes/stability-audit-2026-07-18.md
