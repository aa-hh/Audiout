...
```sh
cd "/Users/ahh/Projects/Audiouter"
```
...
```sh
cd "/Users/ahh/Projects/Audiouter/dev/audiocap"
...
```sh
cd "/Users/ahh/Projects/Audiouter/dev"
...
cd "/Users/ahh/Projects/Audiouter/dev/audiocap"
AC=".build/release/audiocap"
FIFO="/Users/ahh/Projects/Audiouter/dev/owntone/media/spike.fifo"
...
python3 - <<'PY'
import struct, math
data = open("/Users/ahh/Projects/Audiouter/dev/.run/verify-recv.pcm","rb").read()
n = len(data)//2
if n == 0:
