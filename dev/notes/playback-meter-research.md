...
`AudioutSharedUI` (same target as `DeviceRowView`/`ControlCenterSlider`
...
```swift
// AudioutSharedUI/LevelMeterView.swift
import AppKit
import QuartzCore
...
1. **`LevelMeterView`** in `AudioutSharedUI` (§3.5) — layer-backed
