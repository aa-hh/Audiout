...
/// (`AudioutCore` must never import AppKit — package rule,
/// `AudioutCore/AGENTS.md`). ``AudioProcessResolver`` isolates that one seam
...
final class CoreAudioProcessTap: ProcessAudioTap, @unchecked Sendable {
    ...
    private static let telemetryQueue = DispatchQueue(
        label: "com.audiout.perapp.capture.telemetry", qos: .utility)
