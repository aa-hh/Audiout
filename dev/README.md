...
|---|---|---|---|
| **In-app mock backend** | `../AudioutCore` | All UI + control logic: discovery, multiple devices, groups/output-sets, per-device volume/mute/solo, level meters, drop/reconnect | The wire/audio path (by design) |
