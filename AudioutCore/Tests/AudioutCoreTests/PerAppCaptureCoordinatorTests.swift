...
extension SerializedSharedState {
    ...
    @Test func transitionTelemetryIdentifiesWhichCoordinatorInstanceEmittedIt() throws {
        ...
        let metering = PerAppCaptureCoordinator(
            ...
            muteBehavior: .unmuted, name: "AudioutMeter", installsProcessListListener: false)
        ...
        #expect(names == ["AirPlayController", "AudioutMeter"],
        ...
        #expect(stopping.first?["coordinator"] as? String == "AudioutMeter")
