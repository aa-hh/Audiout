...
// No license grant text is present in this header in upstream OwnTone; it is
// treated as BSD by context (paired with evrtsp.h/rtsp.c, same authors/dir).
// See docs/license-inventory.md for the full inventory and this assumption.
/*
...
#define RTSP_CONNECT_TIMEOUT	10
#define RTSP_WRITE_TIMEOUT	15
#define RTSP_READ_TIMEOUT	15
