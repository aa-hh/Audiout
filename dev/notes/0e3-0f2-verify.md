...
```sh
cd "/Users/ahh/Projects/Audiout/dev/audiocap"
...
```sh
cd "/Users/ahh/Projects/Audiout/dev"
...
cd "/Users/ahh/Projects/Audiout/dev/audiocap"
AC=".build/release/audiocap"
FIFO="/Users/ahh/Projects/Audiout/dev/owntone/media/spike.fifo"
...
python3 - <<'PY'
import struct, math
data = open("/Users/ahh/Projects/Audiout/dev/.run/verify-recv.pcm","rb").read()
n = len(data)//2
if n == 0:
