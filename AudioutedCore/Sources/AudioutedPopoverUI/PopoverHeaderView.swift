...
///
/// Layout, left → right:
/// - a **centered title** ("Audiouted", medium ~14pt, label color); and
...
final class PopoverHeaderView: NSView {
    ...
    private let titleLabel = NSTextField(labelWithString: "Audiouted")
    ...
    private func configureAccessibility() {
        ...
        setAccessibilityLabel("Audiouted header")
    }
