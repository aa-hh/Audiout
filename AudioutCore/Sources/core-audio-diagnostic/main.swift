...
func main() -> Int32 {
    guard getenv("AUDIOUT_CORE_AUDIO_DIAGNOSTIC") != nil else {
        print("core-audio-diagnostic: env gate AUDIOUT_CORE_AUDIO_DIAGNOSTIC not set; aborting.")
        print("Usage: AUDIOUT_CORE_AUDIO_DIAGNOSTIC=1 swift run core-audio-diagnostic")
        return 1
    }
