# AUDIOUT UI STRING AUDIT — Phase 3 Polish

Discovery audit of all user-facing strings in Audiout UI packages, reviewed as a paying customer would read them. Flags insider jargon, inconsistent terminology, developer voice, truncation risks, and capitalization mismatches.
...
**Total reviewed: ~170 strings across 7 UI packages** (AudioutApp, PopoverUI, WindowUI, SettingsUI, OnboardingUI, SharedUI, and AppDelegate menu/status items).
...
- **File:line:** AudioutOnboardingUI/OnboardingViewController.swift:69–70
...
- **File:line:** AudioutOnboardingUI/OnboardingViewController.swift:102
...
- **String:** "In System Settings, find Audiout in the list and switch it on."
- **File:line:** AudioutOnboardingUI/OnboardingViewController.swift:277
...
- **Suggested rewrite:** "Go to System Settings › Privacy & Security › Audio Input, find Audiout, and toggle it on." OR better: deep-link directly via the "Open System Settings" button in the permission row itself (already done for Local Network/Audio).
...
- **File:line:** AudioutSettingsUI/GeneralSettingsViewController.swift:45
...
- **String:** "Review what Audiout needs and re-check permissions."
- **File:line:** AudioutSettingsUI/GeneralSettingsViewController.swift:51
...
- **File:line:** AudioutSettingsUI/AudioSettingsViewController.swift:496
...
- **String:** "Symbol name"
- **File:line:** AudioutWindowUI/IconPickerViewController.swift:93
...
- **String:** "No matches"
- **File:line:** AudioutWindowUI/IconPickerViewController.swift:55
...
- **File:line:** AudioutSettingsUI/AudioSettingsViewController.swift:137
...
- **File:line:** AudioutSettingsUI/AudioSettingsViewController.swift:359
...
- **String:** "No Redirect"
- **File:line:** AudioutPopoverUI/PopoverController.swift:1076
...
- **File:line:** AudioutPopoverUI/PopoverController.swift:1080
...
- **File:line:** AudioutPopoverUI/PopoverController.swift:1085
...
- **File:line:** AudioutPopoverUI/PopoverController.swift:678
...
- **File:line:** AudioutPopoverUI/PopoverController.swift:615 (header) vs line 757 (option)
...
- **File:line:** AudioutPopoverUI/PopoverController.swift:761
...
- **File:line:** AudioutPopoverUI/PopoverController.swift:632
...
- **File:line:** AudioutPopoverUI/PopoverController.swift:1224
...
- **File:line:** AudioutWindowUI/MixerWindowController.swift:544
...
- **File:line:** AudioutWindowUI/MixerWindowController.swift:473
...
- **String:** "Group name"
- **File:line:** AudioutWindowUI/GroupEditorViewController.swift:115
...
- **File:line:** AudioutWindowUI/GroupEditorViewController.swift:324
...
- **File:line:** AudioutWindowUI/GroupEditorViewController.swift:325
...
- **String:** "Unavailable"
- **File:line:** AudioutWindowUI/MembershipRowView.swift:100
...
- **File:line:** AudioutWindowUI/DeviceDetailViewController.swift:184
...
- **File:line:** AudioutPopoverUI/ConnectionDiagnosisView.swift:253
...
- **File:line:** AudioutPopoverUI/ConnectionDiagnosisView.swift:251
