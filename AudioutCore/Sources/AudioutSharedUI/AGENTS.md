...
- The FEED column paints a group route like a direct one; only the spoken label names the group.
- `AppRowView`'s destination menu enables items manually; a destination's section comes from its flags.
