...
`AudiouterCore`'s `NativeBackend` consumes — see
...
Audiouter project; see `../PLAN-PHASE-2.md` for the full plan and
...
- **Phase 2b native backend** (`AudiouterCore`'s `NativeBackend`,
  ...
  **DONE.** This engine package doesn't own that code — see
  ...
  `../AudiouterCore/AGENTS.md` for how to run it.
