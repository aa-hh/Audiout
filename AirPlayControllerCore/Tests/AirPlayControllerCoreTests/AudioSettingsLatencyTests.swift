...
@testable import AirPlayControllerSettingsUI
...
final class AudioSettingsLatencyTests: XCTestCase {
    ...
    private func makeExcluded() -> ExcludedAppsController {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("AudioControlTests-\(UUID().uuidString)", isDirectory: true)
    ...
    func testWindowControllerPassesModelThrough() {
        let suite = "AudioControlTests.\(name).\(ObjectIdentifier(self).hashValue)"
