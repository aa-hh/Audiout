...
`AudioutCore`'s `NativeBackend` consumes — see
...
Audiout project; see `../PLAN-PHASE-2.md` for the full plan and
...
- **Phase 2b native backend** (`AudioutCore`'s `NativeBackend`,
  ...
  **DONE.** This engine package doesn't own that code — see
  ...
  `../AudioutCore/AGENTS.md` for how to run it.
