...
public final class DeviceRowView: NSView {
    ...
    public func apply(_ device: Device,
        ...
        // subsumes the unsupported-row rule from T-UI-AP1-1 — an AP1-only row
        // used to suppress the accent tint explicitly; neutral-for-everyone
        // makes that special case moot.)
