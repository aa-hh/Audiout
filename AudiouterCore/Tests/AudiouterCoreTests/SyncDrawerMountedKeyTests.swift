...
@Suite struct SyncDrawerCloseVetoTests {
    ...
    @Test func closingIsRefusedWhileTypingAndTheEditIsKept() throws {
        ...
        #expect(popover.surfaceShouldHide() == false,
                "a dismiss request mid-edit must be refused — Return must never dismiss the surface")
        ...
        #expect(popover.surfaceShouldHide() == true,
